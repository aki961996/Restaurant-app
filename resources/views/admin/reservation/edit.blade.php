                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">First
                                    name</label>
                                <div class="mt-2">
                                    <input type="text" name="name" value="{{$reservations->name}}" id="name"
                            ...
                            <div class="sm:col-span-3">
                                <label for="last_name" class="block text-sm font-medium leading-6 text-gray-900">
                                    Last Name</label>
                                <div class="mt-2">
                                    <input type="text" name="last_name" value="{{$reservations->last_name}}"
                                        id="last_name" autocomplete="given-name" class="block w-full mt-1">
                                </div>
                                @if ($errors->any())
                            ...
                            <div class="sm:col-span-3">
                                <label for="email" class="block text-sm font-medium leading-6 text-gray-900">
                                    Email</label>
                                <div class="mt-2">
                                    <input type="text" name="email" value="{{$reservations->email}}" id="email"
                                        autocomplete="given-name" class="block w-full mt-1">
                                </div>
                                @if ($errors->any())
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="number" name="tel_number" value="{{$reservations->tel_number}}"
                                        id="tel_number" autocomplete="given-name" class="block w-full mt-1">
                                </div>
                                @if ($errors->any())
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="number" min="0.00" max="10000.00" step="0.01"
                                        value="{{$reservations->guest_number}}" name="guest_number" id="guest_number"
                                        autocomplete="" class="block w-full mt-1">
                                </div>
